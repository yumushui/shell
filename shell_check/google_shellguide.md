...
###  ShellCheck
The [ShellCheck project]: [<https://github.com/koalaman/shellcheck>] identifies common bugs and warnings for your shell scripts. It is recommended for all scripts, large or small.
